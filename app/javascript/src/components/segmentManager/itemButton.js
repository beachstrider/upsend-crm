            ...
            >
              {relative.map((o, i) => (
                ...
                >
                  <FormControlLabel
                    control={
                      <Radio checked={o.label === this.state.checkedValue} />
                    }
                    value={o.value}
                    label={o.label}
                  />
            ...
            >
              {relative.map((o, i) => (
                ...
                >
                  <FormControlLabel
                    control={
                      <Radio checked={this.state.selectedOption === o.value} />
                    }
                    value={o.value}
                    label={o.label}
                  />
            ...
            {relative.map((o, i) => {
              return (
                ...
                >
                  <FormControlLabel
                    control={
                      <Radio checked={o.value === this.state.checkedValue} />
                    }
                    value={o.value}
                    label={o.label}
                  />

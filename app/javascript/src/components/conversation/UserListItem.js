...
const useStyles = makeStyles((theme) => ({
  ...
  highlightedItem: {
    ...
    borderLeft: 'solid 6px rgba(255, 211, 0)',
    zIndex: 1
  },
  defaultItem: {
    flexFlow: "column",
  ...
  graDivider: {
    height: "2px",
    backgroundImage: "linear-gradient(to right, rgba(255,255,255,1), rgba(255, 211, 0, 0), rgba(255, 211, 0, 1), rgba(255, 211, 0, 0), rgba(255,255,255,1))",
...
function AlignItemsList(props) {
  ...
  return (
    <List className={classes.root}>
      ...
      <Divider className={classes.graDivider} variant="fullWidth" component="li" />
    </List>
  );
}

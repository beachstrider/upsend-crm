...
class AppUser < ApplicationRecord
  ...
  def avatar_url 
    return "https://avatars.dicebear.com/v2/gridy/#{id}.svg?mood[]=happy" if email.blank? && name.blank?
    return "https://avatars.dicebear.com/v2/initials/#{name}.svg" if email.blank? && name.present? 
    "https://avatars.dicebear.com/v2/avataaars/#{CGI.escape(email.downcase)}.svg?mood[]=happy" 
  end

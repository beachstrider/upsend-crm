...
module Types
  class MutationType < Types::BaseObject
    ...
    field :createSubscription, mutation: Mutations::Apps::CreateSubscription
    ...
    field :createSesIdentity, mutation: Mutations::SesIdentities::CreateSesIdentity
    field :updateSesIdentity, mutation: Mutations::SesIdentities::UpdateSesIdentity
    field :deleteSesIdentity, mutation: Mutations::SesIdentities::DeleteSesIdentity

    field :updateAccountDetails, mutation: Mutations::UpdateAccountDetails

...
ActiveRecord::Schema.define(version: 2020_05_10_070712) do
  ...
  create_table "plans", force: :cascade do |t|
    ...
    t.integer "additional_contacts"
    t.integer "additional_emails"
    t.string "category"
    t.string "plan_type"
    t.string "parent_stripe_plan_id"
    t.decimal "amount_decimal"
  end
  ...
  create_table "ses_identities", force: :cascade do |t|
    t.string "address"
